      ...
      <div class="container">
        <div class="row">
          <div class="intro-text">
            ...
            <a href="/penawaran" type="button" class="btn btn-custom btn-lg page-scroll">
              Dapatkan Penawaran
            </a></div>
        </div>
      </div>
...
<div id="about">
  <div class="container">
    ...
    <div class="row">
      <div class="col-xs-12 col-md-6 text-center"> <img src="img/intro-bg2.jpg" width="100%" height="500px" alt=""> </div>
